...
OdomBroadcaster::OdomBroadcaster(void)
{
    ...
    odom_yaw_sub = nh.subscribe<std_msgs::Float32>("base/odom/yaw", 10, &OdomBroadcaster::odomYawCallback, this);
    odom_x_sub = nh.subscribe<std_msgs::Float32>("base/odom/x", 10, &OdomBroadcaster::odomXCallback, this);
    odom_y_sub = nh.subscribe<std_msgs::Float32>("base/odom/y", 10, &OdomBroadcaster::odomYCallback, this);
